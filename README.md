...
> **源码基线说明**：`yonggekkk/x-ui-yg` 的仓库 README 明确写明“本项目并不开源”，仓库主体也是预编译 `x-ui` 二进制和安装包，无法可靠地直接修改其后端/前端源码。因此本项目不对闭源二进制做逆向修改，而是以 GPL-3.0 开源项目 `MHSanaei/3x-ui` 为可审计源码基线，在固定上游提交上应用 MiniJet 改造。
